...
const ledgerCmd = `${chalk.cyan(`${cliName} ledger <journal.yml> [--chart <chart.yml>]`)}`
const ledgerDesc = `Shows the general ledger from the given <journal.yml> and <chart.yml>`
const bsCmd = `${chalk.cyan(`${cliName} bs <journal.yml> [--chart <chart.yml>]`)}`
const bsDesc = `Shows the balance sheet from the given <journal.yml> and <chart.yml>`

const monthlyCmd = `${chalk.cyan(`${cliName} monthly <journal.yml> <accountType> [--chart <chart.yml>]`)}`
const monthlyDesc = `Shows the monthly totals of the given account type subledger from the given journal.yml and chart.yml`

const monthlyLedgerCmd = `${chalk.cyan(`${cliName} monthly-ledger <journal.yml> <accountType> [--chart <chart.yml>]`)}`
